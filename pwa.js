...
const cacheName = 'Exam1EthanHall-2021-03-15 15:40:43.908476'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Exam1EthanHall'.length) === 'Exam1EthanHall') {
